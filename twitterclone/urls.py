...
from twitterclone.tweet import views as tweet_views
from twitterclone.twitteruser import views as twitteruser_views
...
urlpatterns = [
    ...
    path('login/', auth_views.login_view, name='index'),
